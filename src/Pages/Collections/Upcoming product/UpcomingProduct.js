...
const UpcomingProduct = () => {
    ...
    const url = `https://furniture-collections-server-site.vercel.app/upcomin_furnituers`;
            ...
            <div className="upcoming">
                <div className="d-flex justify-content-center ">
                    <marquee className='marquees pt-1' direction="left" >
                        <h5> This Year 2023 Our Shop UpComing <span className='text-primary'>Furniture Collections</span> & <span className='text-warning'> Best Discount </span> Offer<span className='text-danger'> Our Happy Customar ❤❤</span> .</h5>
                    </marquee>
                </div>
                                        ...
                                        <div className="p-bottom d-flex justify-content-between mt-2">
                                            ...
                                            <div className="wrapper ">
                                                <span className="bg-success p-1" >
                                                    <span className='text-white pointer'>{product?.Date}</span>

                                                </span>
                                            </div>
                                            <div className="wrapper">
                                                <span className="bg-primary p-1" >
                                                    <span className='text-white pointer'>{product?.off} Discount</span>
